...
class Main {
  ...
  static void saveNoteType(NoteType type) async {
    // Speichern des Notentyps
    noteType = type;
    SharedPreferences prefs = await SharedPreferences.getInstance();
    await prefs.setString("notetype", type.toString());
  }

  static void saveGradeColorMarking() async {
    // Speichern der farblichen Markierung
    SharedPreferences prefs = await SharedPreferences.getInstance();
    await prefs.setBool("gradeColorMarking", gradeColorMarking);
  }

  static Future<NoteType> loadNoteType() async {
    // Laden des Notentyps
    SharedPreferences prefs = await SharedPreferences.getInstance();
  ...
  static Future<void> loadGradeColorMarking() async {
    // Laden der farblichen Markierung
    SharedPreferences prefs = await SharedPreferences.getInstance();
  ...
  static void saveSubject(Subject subject) async {
    // Einzelnes Fach fest auf dem Handy speichern
    SharedPreferences prefs = await SharedPreferences.getInstance();
    List<String> list = [];
  ...
  static void resaveAllSubjects() async {
    // Alle Fächer neu Speichern anhand aktueller temporären Liste
    SharedPreferences prefs = await SharedPreferences.getInstance();
    List<String> list = [];

    for (Subject subject in subjectList) list.add(subject.toJson());
  ...
  static void deleteAllData() async {
    // Alle Daten löschen
    SharedPreferences prefs = await SharedPreferences.getInstance();
    if (prefs.containsKey("subjects")) prefs.remove("subjects");
    if (prefs.containsKey("notetype")) prefs.remove("notetype");
  }

  static String saveAllDataToJson() {
    // Alle Daten zu JSON konvertieren
    List<dynamic> list = [];
  ...
  static void loadAllDataFromJson(String jsonData) {
    // Alle Daten von JSON laden
